...
Profiler &Runtime::profiler() { return m_profiler; }

ExecutionManager &Runtime::executionManager() { return m_executionManager; }

DataManager &Runtime::dataManager() {
    return m_executionManager.getDataManager();
}

Clock &Runtime::clock() { return m_clock; }

Framework &Runtime::framework() { return m_framework; }

std::string Runtime::name() const { return m_name; }

ExecutionType Runtime::executionType() const { return m_executionType; }

void Runtime::executionType(ExecutionType type) { m_executionType = type; }
...
void Runtime::join() { m_thread.join(); }
...
Runtime::getServiceWrapper(std::string const &name) {
